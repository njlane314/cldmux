// A small, dependency-free build tool for producing the distributable cloud.h.
...
std::optional<std::string> project_include(std::string_view line,
    ...
    // generated release dependent on the modular include tree.
...
public:
    ...
    amalgamation generate() {
        output_ = "// cloud.h\n"
                  "// Generated from the modular cloud sources.\n"
                  "// Do not edit this file directly.\n"
                  "\n"
                  "#ifndef NJLANE314_CLOUD_SINGLE_INCLUDE_H_INCLUDED\n"
                  "#define NJLANE314_CLOUD_SINGLE_INCLUDE_H_INCLUDED\n"
                  "\n";

        emit(root_);
        output_ += "#endif // NJLANE314_CLOUD_SINGLE_INCLUDE_H_INCLUDED\n";
...
struct options {
    ...
    fs::path output = "single_include/cloud.h";
